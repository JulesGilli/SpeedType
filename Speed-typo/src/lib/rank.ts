...
export const TIERS: Tier[] = [
  ...
  { key: 'silver', min: 14000, color: '#cbd5e1' },
  { key: 'gold', min: 18000, color: '#facc15' },
  { key: 'diamond', min: 22000, color: '#a78bfa' },
  { key: 'master', min: 26000, color: '#f472b6' },
  { key: 'grandmaster', min: 30000, color: '#ef4444' },
];
