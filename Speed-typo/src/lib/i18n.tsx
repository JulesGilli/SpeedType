...
const fr: Dict = {
  ...
  rankInfoTitle: 'Les rangs',
  rankInfoHint: 'Ton rang dépend de ton score global du mois (somme de tes meilleurs scores par mode).',
...
const en: Dict = {
  ...
  rankInfoTitle: 'Ranks',
  rankInfoHint: 'Your rank is based on your monthly global score (sum of your best scores per mode).',
  introEnter: 'to enter',
...
const es: Dict = {
  ...
  rankInfoTitle: 'Los rangos',
  rankInfoHint: 'Tu rango depende de tu puntuación global del mes (suma de tus mejores puntuaciones por modo).',
...
const de: Dict = {
  ...
  rankInfoTitle: 'Die Ränge',
  rankInfoHint: 'Dein Rang basiert auf deiner monatlichen Gesamtpunktzahl (Summe deiner besten Punktzahlen pro Modus).',
...
const it: Dict = {
  ...
  rankInfoTitle: 'I ranghi',
  rankInfoHint: 'Il tuo rango dipende dal punteggio globale del mese (somma dei tuoi migliori punteggi per modalità).',
