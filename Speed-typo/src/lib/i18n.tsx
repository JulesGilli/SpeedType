...
const fr: Dict = {
  ...
  bossDesc: 'Affronte un boss en 3 phases. Tape tes cartes pour attaquer, parer et lancer des sorts. Améliore ton deck entre les combats.',
  bossPhase: 'Phase',
  bossYou: 'Toi',
  bossRage: 'RAGE',
...
const en: Dict = {
  ...
  bossDesc: 'Fight a 3-phase boss. Type your cards to attack, parry and cast spells. Upgrade your deck between fights.',
  bossPhase: 'Phase',
  bossYou: 'You',
  bossRage: 'RAGE',
...
const es: Dict = {
  ...
  bossDesc: 'Enfréntate a un jefe de 3 fases. Escribe tus cartas para atacar, parar y lanzar hechizos. Mejora tu mazo entre combates.',
  bossPhase: 'Fase',
  bossYou: 'Tú',
  bossRage: 'FURIA',
...
const de: Dict = {
  ...
  bossTitle: 'Bosskampf',
  bossDesc: 'Bekämpfe einen Boss in 3 Phasen. Tippe deine Karten, um anzugreifen, zu parieren und Zauber zu wirken. Verbessere dein Deck zwischen den Kämpfen.',
  bossPhase: 'Phase',
  bossYou: 'Du',
  bossRage: 'WUT',
...
const it: Dict = {
  ...
  bossDesc: 'Affronta un boss in 3 fasi. Scrivi le tue carte per attaccare, parare e lanciare incantesimi. Migliora il tuo mazzo tra i combattimenti.',
  bossPhase: 'Fase',
  bossYou: 'Tu',
  bossRage: 'IRA',
