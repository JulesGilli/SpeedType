...
const fr: Dict = {
  ...
  hardcore: 'Hardcore',
  hardcoreLocked: 'Atteins le rang Master pour débloquer le mode Hardcore',
  hardcoreChoose: 'Choisis ton épreuve',
  back: 'Retour',
  chaosTitle: 'Chaos',
  chaosDesc: 'Tous les modes à la fois : leet, inversé, mémoire et aveugle.',
  suddenTitle: 'Mort subite',
  suddenDesc: 'Comme le mode Classique, mais la moindre faute t’élimine.',
  blitzTitle: 'Blitz',
  blitzDesc: '5 s par mot, −5 % à chaque mot. Tape le mot bonus du dessus avant pour des points en plus.',
  bossTitle: 'Combat de Boss',
  bossDesc: 'Affronte un boss en 10 phases. Tape tes cartes pour attaquer, parer et lancer des sorts. Améliore ton deck entre les combats.',
  bossPhase: 'Phase',
  bossYou: 'Toi',
  bossRage: 'RAGE',
  bossRarity_common: 'Commune',
  bossRarity_rare: 'Rare',
  bossRarity_epic: 'Épique',
  bossRarity_legendary: 'Légendaire',
  bossShieldBlock: 'BLOQUÉ !',
  bossShieldOn: 'BOUCLIER !',
  bossRageOn: 'RAGE !',
  bossIncantWarn: 'COUP FATAL — tape l’incantation !',
  bossIncantCountered: 'CONTRÉ !',
  bossEnrage: 'ENRAGÉ',
  bossBestProgress: 'Meilleure progression',
  bossNewRecord: 'NOUVEAU RECORD',
  bossUpgrades: 'améliorations',
  bossHowTo: 'Comment jouer',
  bossTutAttackT: 'Attaquer',
  bossTutAttackD: 'Tape le mot d’une carte d’attaque (ex. « frappe ») pour envoyer un projectile sur le boss.',
  bossTutDefenseT: 'Parer / esquiver',
  bossTutDefenseD: 'Tape « parade » ou « esquive » : ça brise d’un coup TOUS les projectiles ennemis en vol. Un projectile blindé (🛡🛡) demande 2 parades.',
  bossTutNameT: 'Détruire une attaque',
  bossTutNameD: 'Tape le nom écrit sur un projectile ennemi (ex. « virus ») pour le détruire seul — une seule fois suffit, même blindé.',
  bossTutSpellT: 'Sorts',
  bossTutSpellD: '« soin » rend des PV, « bouclier » absorbe le prochain coup, « rage » double tes dégâts un moment. Chaque carte a un temps de recharge.',
  bossTutIncantT: 'Coup fatal',
  bossTutIncantD: 'Quand le boss charge une incantation, tape vite le mot affiché avant la fin de la barre — sinon c’est la mort instantanée.',
  bossTutGoldT: 'Or & cartes',
  bossTutGoldD: 'Franchir une phase rapporte de l’or, et même en perdant tu en gagnes selon les dégâts. Dépense-le pour améliorer tes cartes ou ouvrir des boosters (cartes rares comme « doom »).',
  bossTutPhasesT: '10 phases',
  bossTutPhasesD: 'Le boss a 10 phases, chacune un boss plus coriace (salves, régénération, enrage…). Va le plus loin possible !',
  bossTypePlaceholder: 'Tape une carte (attaque, parade, soin…)',
  bossDeck: 'Ton deck',
  bossDeckHint: 'Clique pour retirer',
  bossUnequip: 'Retirer',
  bossEquip: 'Équiper',
  bossCollection: 'Ta collection',
  bossOpenBooster: 'Ouvrir un booster',
  bossFight: 'Combattre',
  bossNotEnoughGold: 'Pas assez d’or.',
  bossNewCard: 'Nouvelle carte !',
  bossDuplicate: 'Doublon (carte déjà possédée)',
  bossClose: 'Fermer',
  bossVictory: 'VICTOIRE !',
  bossDefeat: 'DÉFAITE',
  bossPhasesCleared: 'Phases franchies',
  bossDamageDealt: 'Dégâts infligés',
  bossGoldEarned: 'Or gagné',
  bossBackToLobby: 'Retour au lobby',
  bossValidateScore: 'Valider le score',
  bonus: 'Bonus',
  loginTitle: 'Connexion',
  loginPrompt: 'Connecte-toi pour enregistrer tes scores et apparaître au classement.',
  email: 'Email',
  password: 'Mot de passe',
  usernameField: 'Pseudo',
  chooseUsernameTitle: 'Choisis ton pseudo',
  chooseUsernamePrompt: 'Ce nom apparaîtra dans les classements.',
  confirmUsername: 'Valider',
  usernameTaken: 'Ce pseudo est déjà pris.',
  usernameTooShort: '3 caractères minimum.',
  signIn: 'Se connecter',
  signUp: 'Créer un compte',
  toSignUp: 'Pas de compte ? Inscris-toi',
  toSignIn: 'Déjà un compte ? Connecte-toi',
  playAsGuest: 'Jouer sans compte',
  orWord: 'ou',
  ranking: 'Rangs',
  championPlaceholder: 'Ton message de champion…',
  publish: 'Publier',
  championPrompt: 'Tu es n°1 — laisse un message à tous !',
...
const en: Dict = {
  ...
  hardcore: 'Hardcore',
  hardcoreLocked: 'Reach Master rank to unlock Hardcore mode',
  hardcoreChoose: 'Choose your trial',
  back: 'Back',
  chaosTitle: 'Chaos',
  chaosDesc: 'All modes at once: leet, reversed, memory and blind.',
  suddenTitle: 'Sudden Death',
  suddenDesc: 'Like Classic, but a single typo eliminates you.',
  blitzTitle: 'Blitz',
  blitzDesc: '5s per word, −5% each word. Type the bonus word above first for extra points.',
  bossTitle: 'Boss Battle',
  bossDesc: 'Fight a 10-phase boss. Type your cards to attack, parry and cast spells. Upgrade your deck between fights.',
  bossPhase: 'Phase',
  bossYou: 'You',
  bossRage: 'RAGE',
  bossRarity_common: 'Common',
  bossRarity_rare: 'Rare',
  bossRarity_epic: 'Epic',
  bossRarity_legendary: 'Legendary',
  bossShieldBlock: 'BLOCKED!',
  bossShieldOn: 'SHIELD!',
  bossRageOn: 'RAGE!',
  bossIncantWarn: 'DEADLY BLOW — type the incantation!',
  bossIncantCountered: 'COUNTERED!',
  bossEnrage: 'ENRAGED',
  bossBestProgress: 'Best progress',
  bossNewRecord: 'NEW RECORD',
  bossUpgrades: 'upgrades',
  bossHowTo: 'How to play',
  bossTutAttackT: 'Attack',
  bossTutAttackD: 'Type an attack card’s word (e.g. “frappe”) to launch a projectile at the boss.',
  bossTutDefenseT: 'Parry / dodge',
  bossTutDefenseD: 'Type “parade” or “esquive” to shatter ALL incoming enemy projectiles at once. An armored one (🛡🛡) needs 2 parries.',
  bossTutNameT: 'Destroy an attack',
  bossTutNameD: 'Type the name shown on an enemy projectile (e.g. “virus”) to destroy just that one — once is enough, even armored.',
  bossTutSpellT: 'Spells',
  bossTutSpellD: '“soin” restores HP, “bouclier” blocks the next hit, “rage” doubles your damage for a while. Every card has a cooldown.',
  bossTutIncantT: 'Deadly blow',
  bossTutIncantD: 'When the boss charges an incantation, quickly type the shown word before the bar empties — otherwise it’s an instant kill.',
  bossTutGoldT: 'Gold & cards',
  bossTutGoldD: 'Clearing a phase earns gold, and even losing pays out based on damage dealt. Spend it to upgrade cards or open boosters (rare cards like “doom”).',
  bossTutPhasesT: '10 phases',
  bossTutPhasesD: 'The boss has 10 phases, each a tougher boss (salvos, regen, enrage…). Get as far as you can!',
  bossTypePlaceholder: 'Type a card (attack, parry, heal…)',
  bossDeck: 'Your deck',
  bossDeckHint: 'Click to remove',
  bossUnequip: 'Remove',
  bossEquip: 'Equip',
  bossCollection: 'Your collection',
  bossOpenBooster: 'Open a booster',
  bossFight: 'Fight',
  bossNotEnoughGold: 'Not enough gold.',
  bossNewCard: 'New card!',
  bossDuplicate: 'Duplicate (already owned)',
  bossClose: 'Close',
  bossVictory: 'VICTORY!',
  bossDefeat: 'DEFEAT',
  bossPhasesCleared: 'Phases cleared',
  bossDamageDealt: 'Damage dealt',
  bossGoldEarned: 'Gold earned',
  bossBackToLobby: 'Back to lobby',
  bossValidateScore: 'Submit score',
  bonus: 'Bonus',
  loginTitle: 'Sign in',
  loginPrompt: 'Sign in to save your scores and appear on the leaderboard.',
  email: 'Email',
  password: 'Password',
  usernameField: 'Username',
  chooseUsernameTitle: 'Choose your username',
  chooseUsernamePrompt: 'This name will appear on the leaderboards.',
  ...
  orWord: 'or',
  ranking: 'Ranking',
  championPlaceholder: 'Your champion message…',
  publish: 'Publish',
  championPrompt: 'You are #1 — leave a message for everyone!',
  introEnter: 'to enter',
...
const es: Dict = {
  ...
  hardcore: 'Hardcore',
  hardcoreLocked: 'Alcanza el rango Maestro para desbloquear el modo Hardcore',
  hardcoreChoose: 'Elige tu prueba',
  back: 'Volver',
  chaosTitle: 'Caos',
  chaosDesc: 'Todos los modos a la vez: leet, invertido, memoria y a ciegas.',
  suddenTitle: 'Muerte súbita',
  suddenDesc: 'Como el Clásico, pero un solo error te elimina.',
  blitzTitle: 'Blitz',
  blitzDesc: '5s por palabra, −5% por palabra. Escribe antes la palabra bonus de arriba para puntos extra.',
  bossTitle: 'Combate de Jefe',
  bossDesc: 'Enfréntate a un jefe de 10 fases. Escribe tus cartas para atacar, parar y lanzar hechizos. Mejora tu mazo entre combates.',
  bossPhase: 'Fase',
  bossYou: 'Tú',
  bossRage: 'FURIA',
  bossRarity_common: 'Común',
  bossRarity_rare: 'Rara',
  bossRarity_epic: 'Épica',
  bossRarity_legendary: 'Legendaria',
  bossShieldBlock: '¡BLOQUEADO!',
  bossShieldOn: '¡ESCUDO!',
  bossRageOn: '¡FURIA!',
  bossIncantWarn: '¡GOLPE FATAL — escribe el conjuro!',
  bossIncantCountered: '¡CONTRADO!',
  bossEnrage: 'ENFURECIDO',
  bossBestProgress: 'Mejor progreso',
  bossNewRecord: 'NUEVO RÉCORD',
  bossUpgrades: 'mejoras',
  bossHowTo: 'Cómo jugar',
  bossTutAttackT: 'Atacar',
  bossTutAttackD: 'Escribe la palabra de una carta de ataque (p. ej. “frappe”) para lanzar un proyectil al jefe.',
  bossTutDefenseT: 'Parar / esquivar',
  bossTutDefenseD: 'Escribe “parade” o “esquive”: rompe de golpe TODOS los proyectiles enemigos en vuelo. Uno blindado (🛡🛡) necesita 2 paradas.',
  bossTutNameT: 'Destruir un ataque',
  bossTutNameD: 'Escribe el nombre de un proyectil enemigo (p. ej. “virus”) para destruir solo ese — una vez basta, incluso blindado.',
  bossTutSpellT: 'Hechizos',
  bossTutSpellD: '“soin” cura PV, “bouclier” bloquea el próximo golpe, “rage” duplica tu daño un rato. Cada carta tiene enfriamiento.',
  bossTutIncantT: 'Golpe fatal',
  bossTutIncantD: 'Cuando el jefe carga un conjuro, escribe rápido la palabra mostrada antes de que se vacíe la barra — o será muerte instantánea.',
  bossTutGoldT: 'Oro y cartas',
  bossTutGoldD: 'Superar una fase da oro, y hasta perdiendo ganas según el daño infligido. Gástalo para mejorar cartas o abrir sobres (cartas raras como “doom”).',
  bossTutPhasesT: '10 fases',
  bossTutPhasesD: 'El jefe tiene 10 fases, cada una un jefe más duro (ráfagas, regeneración, furia…). ¡Llega lo más lejos posible!',
  bossTypePlaceholder: 'Escribe una carta (ataque, parada, cura…)',
  bossDeck: 'Tu mazo',
  bossDeckHint: 'Clic para quitar',
  bossUnequip: 'Quitar',
  bossEquip: 'Equipar',
  bossCollection: 'Tu colección',
  bossOpenBooster: 'Abrir un sobre',
  bossFight: 'Combatir',
  bossNotEnoughGold: 'Oro insuficiente.',
  bossNewCard: '¡Carta nueva!',
  bossDuplicate: 'Duplicado (ya la tienes)',
  bossClose: 'Cerrar',
  bossVictory: '¡VICTORIA!',
  bossDefeat: 'DERROTA',
  bossPhasesCleared: 'Fases superadas',
  bossDamageDealt: 'Daño infligido',
  bossGoldEarned: 'Oro ganado',
  bossBackToLobby: 'Volver al lobby',
  bossValidateScore: 'Enviar puntuación',
  bonus: 'Bonus',
  loginTitle: 'Iniciar sesión',
  loginPrompt: 'Inicia sesión para guardar tus puntuaciones y aparecer en la clasificación.',
  email: 'Email',
  password: 'Contraseña',
  usernameField: 'Usuario',
  chooseUsernameTitle: 'Elige tu usuario',
  chooseUsernamePrompt: 'Este nombre aparecerá en las clasificaciones.',
  ...
  playAsGuest: 'Jugar sin cuenta',
  orWord: 'o',
  ranking: 'Rangos',
  championPlaceholder: 'Tu mensaje de campeón…',
  publish: 'Publicar',
  championPrompt: '¡Eres el n.º 1! Deja un mensaje para todos.',
...
const de: Dict = {
  ...
  hardcore: 'Hardcore',
  hardcoreLocked: 'Erreiche den Master-Rang, um den Hardcore-Modus freizuschalten',
  hardcoreChoose: 'Wähle deine Prüfung',
  back: 'Zurück',
  chaosTitle: 'Chaos',
  chaosDesc: 'Alle Modi gleichzeitig: Leet, umgekehrt, Gedächtnis und blind.',
  suddenTitle: 'Sudden Death',
  suddenDesc: 'Wie Klassisch, aber ein einziger Tippfehler scheidet dich aus.',
  blitzTitle: 'Blitz',
  blitzDesc: '5s pro Wort, −5% je Wort. Tippe zuerst das Bonuswort oben für Extrapunkte.',
  bossTitle: 'Bosskampf',
  bossDesc: 'Bekämpfe einen Boss in 10 Phasen. Tippe deine Karten, um anzugreifen, zu parieren und Zauber zu wirken. Verbessere dein Deck zwischen den Kämpfen.',
  bossPhase: 'Phase',
  bossYou: 'Du',
  bossRage: 'WUT',
  bossRarity_common: 'Gewöhnlich',
  bossRarity_rare: 'Selten',
  bossRarity_epic: 'Episch',
  bossRarity_legendary: 'Legendär',
  bossShieldBlock: 'GEBLOCKT!',
  bossShieldOn: 'SCHILD!',
  bossRageOn: 'WUT!',
  bossIncantWarn: 'TÖDLICHER SCHLAG — tippe die Beschwörung!',
  bossIncantCountered: 'GEKONTERT!',
  bossEnrage: 'RASEND',
  bossBestProgress: 'Bester Fortschritt',
  bossNewRecord: 'NEUER REKORD',
  bossUpgrades: 'Upgrades',
  bossHowTo: 'So wird gespielt',
  bossTutAttackT: 'Angreifen',
  bossTutAttackD: 'Tippe das Wort einer Angriffskarte (z. B. „frappe“), um ein Geschoss auf den Boss zu schleudern.',
  bossTutDefenseT: 'Parieren / ausweichen',
  bossTutDefenseD: 'Tippe „parade“ oder „esquive“: zerschlägt auf einen Schlag ALLE anfliegenden Geschosse. Ein gepanzertes (🛡🛡) braucht 2 Paraden.',
  bossTutNameT: 'Angriff zerstören',
  bossTutNameD: 'Tippe den Namen auf einem gegnerischen Geschoss (z. B. „virus“), um nur dieses zu zerstören — einmal genügt, auch gepanzert.',
  bossTutSpellT: 'Zauber',
  bossTutSpellD: '„soin“ heilt LP, „bouclier“ blockt den nächsten Treffer, „rage“ verdoppelt kurz deinen Schaden. Jede Karte hat eine Abklingzeit.',
  bossTutIncantT: 'Tödlicher Schlag',
  bossTutIncantD: 'Wenn der Boss eine Beschwörung auflädt, tippe schnell das angezeigte Wort, bevor die Leiste leer ist — sonst ist es sofortiger Tod.',
  bossTutGoldT: 'Gold & Karten',
  bossTutGoldD: 'Eine Phase zu schaffen bringt Gold, und selbst Verlieren zahlt sich je nach Schaden aus. Gib es für Kartenupgrades oder Booster aus (seltene Karten wie „doom“).',
  bossTutPhasesT: '10 Phasen',
  bossTutPhasesD: 'Der Boss hat 10 Phasen, jede ein härterer Boss (Salven, Regeneration, Rage…). Komm so weit wie möglich!',
  bossTypePlaceholder: 'Tippe eine Karte (Angriff, Parade, Heilung…)',
  bossDeck: 'Dein Deck',
  bossDeckHint: 'Klicken zum Entfernen',
  bossUnequip: 'Entfernen',
  bossEquip: 'Ausrüsten',
  bossCollection: 'Deine Sammlung',
  bossOpenBooster: 'Booster öffnen',
  bossFight: 'Kämpfen',
  bossNotEnoughGold: 'Nicht genug Gold.',
  bossNewCard: 'Neue Karte!',
  bossDuplicate: 'Duplikat (bereits vorhanden)',
  bossClose: 'Schließen',
  bossVictory: 'SIEG!',
  bossDefeat: 'NIEDERLAGE',
  bossPhasesCleared: 'Phasen geschafft',
  bossDamageDealt: 'Schaden verursacht',
  bossGoldEarned: 'Gold erhalten',
  bossBackToLobby: 'Zurück zur Lobby',
  bossValidateScore: 'Punktzahl senden',
  bonus: 'Bonus',
  loginTitle: 'Anmelden',
  loginPrompt: 'Melde dich an, um deine Punkte zu speichern und in der Bestenliste zu erscheinen.',
  email: 'E-Mail',
  password: 'Passwort',
  usernameField: 'Benutzername',
  chooseUsernameTitle: 'Wähle deinen Benutzernamen',
  chooseUsernamePrompt: 'Dieser Name erscheint in den Bestenlisten.',
  confirmUsername: 'Bestätigen',
  ...
  playAsGuest: 'Ohne Konto spielen',
  orWord: 'oder',
  ranking: 'Ränge',
  championPlaceholder: 'Deine Champion-Nachricht…',
  publish: 'Veröffentlichen',
  championPrompt: 'Du bist die Nr. 1 — hinterlasse allen eine Nachricht!',
...
const it: Dict = {
  ...
  hardcore: 'Hardcore',
  hardcoreLocked: 'Raggiungi il rango Maestro per sbloccare la modalità Hardcore',
  hardcoreChoose: 'Scegli la tua prova',
  back: 'Indietro',
  chaosTitle: 'Caos',
  chaosDesc: 'Tutte le modalità insieme: leet, invertito, memoria e alla cieca.',
  suddenTitle: 'Morte improvvisa',
  suddenDesc: 'Come Classico, ma un solo errore ti elimina.',
  blitzTitle: 'Blitz',
  blitzDesc: '5s per parola, −5% a ogni parola. Scrivi prima la parola bonus in alto per punti extra.',
  bossTitle: 'Battaglia col Boss',
  bossDesc: 'Affronta un boss in 10 fasi. Scrivi le tue carte per attaccare, parare e lanciare incantesimi. Migliora il tuo mazzo tra i combattimenti.',
  bossPhase: 'Fase',
  bossYou: 'Tu',
  bossRage: 'IRA',
  bossRarity_common: 'Comune',
  bossRarity_rare: 'Rara',
  bossRarity_epic: 'Epica',
  bossRarity_legendary: 'Leggendaria',
  bossShieldBlock: 'BLOCCATO!',
  bossShieldOn: 'SCUDO!',
  bossRageOn: 'IRA!',
  bossIncantWarn: 'COLPO FATALE — scrivi l’incantesimo!',
  bossIncantCountered: 'PARATO!',
  bossEnrage: 'INFURIATO',
  bossBestProgress: 'Miglior progresso',
  bossNewRecord: 'NUOVO RECORD',
  bossUpgrades: 'potenziamenti',
  bossHowTo: 'Come si gioca',
  bossTutAttackT: 'Attaccare',
  bossTutAttackD: 'Scrivi la parola di una carta d’attacco (es. “frappe”) per lanciare un proiettile sul boss.',
  bossTutDefenseT: 'Parare / schivare',
  bossTutDefenseD: 'Scrivi “parade” o “esquive”: frantuma in un colpo TUTTI i proiettili nemici in volo. Uno corazzato (🛡🛡) richiede 2 parate.',
  bossTutNameT: 'Distruggere un attacco',
  bossTutNameD: 'Scrivi il nome su un proiettile nemico (es. “virus”) per distruggere solo quello — una volta basta, anche corazzato.',
  bossTutSpellT: 'Incantesimi',
  bossTutSpellD: '“soin” cura PV, “bouclier” blocca il prossimo colpo, “rage” raddoppia i danni per un po’. Ogni carta ha un cooldown.',
  bossTutIncantT: 'Colpo fatale',
  bossTutIncantD: 'Quando il boss carica un incantesimo, scrivi in fretta la parola mostrata prima che la barra si svuoti — altrimenti è morte istantanea.',
  bossTutGoldT: 'Oro e carte',
  bossTutGoldD: 'Superare una fase dà oro, e anche perdendo guadagni in base ai danni. Spendilo per potenziare carte o aprire pacchetti (carte rare come “doom”).',
  bossTutPhasesT: '10 fasi',
  bossTutPhasesD: 'Il boss ha 10 fasi, ognuna un boss più duro (raffiche, rigenerazione, furia…). Arriva più lontano che puoi!',
  bossTypePlaceholder: 'Scrivi una carta (attacco, parata, cura…)',
  bossDeck: 'Il tuo mazzo',
  bossDeckHint: 'Clicca per rimuovere',
  bossUnequip: 'Rimuovi',
  bossEquip: 'Equipaggia',
  bossCollection: 'La tua collezione',
  bossOpenBooster: 'Apri un pacchetto',
  bossFight: 'Combatti',
  bossNotEnoughGold: 'Oro insufficiente.',
  bossNewCard: 'Nuova carta!',
  bossDuplicate: 'Doppione (già posseduta)',
  bossClose: 'Chiudi',
  bossVictory: 'VITTORIA!',
  bossDefeat: 'SCONFITTA',
  bossPhasesCleared: 'Fasi superate',
  bossDamageDealt: 'Danni inflitti',
  bossGoldEarned: 'Oro guadagnato',
  bossBackToLobby: 'Torna alla lobby',
  bossValidateScore: 'Invia punteggio',
  bonus: 'Bonus',
  loginTitle: 'Accedi',
  loginPrompt: 'Accedi per salvare i tuoi punteggi e comparire in classifica.',
  email: 'Email',
  password: 'Password',
  usernameField: 'Nome utente',
  chooseUsernameTitle: 'Scegli il tuo nome utente',
  chooseUsernamePrompt: 'Questo nome apparirà nelle classifiche.',
  confirmUsername: 'Conferma',
  usernameTaken: 'Questo nome utente è già in uso.',
  usernameTooShort: 'Minimo 3 caratteri.',
  signIn: 'Accedi',
  signUp: 'Crea account',
  toSignUp: 'Nessun account? Registrati',
  toSignIn: 'Hai già un account? Accedi',
  playAsGuest: 'Gioca senza account',
  orWord: 'o',
  ranking: 'Ranghi',
  championPlaceholder: 'Il tuo messaggio da campione…',
  publish: 'Pubblica',
  championPrompt: 'Sei il n°1 — lascia un messaggio a tutti!',
