...
// wrapEffect au niveau module (évite de re-wrapper à chaque rendu). Cast en any :
// les types de wrapEffect varient selon les versions de @react-three/postprocessing.
